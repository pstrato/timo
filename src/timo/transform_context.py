...
from flax.nnx import Param, Initializer
...
class TransformContext:
    ...
    def initializer(self, factory: TransformFactory, kind, default=_unset) -> Initializer:
    ...
    def push(self, factory: TransformFactory):
        return TransformContext(self, input_shapes=factory.output_shapes)
